...
describe("Eligibility", () => {
  ...
  describe("Basic condition", () => {
    ...
    it("should be eligible with random same keys and random same values", () => {
    ...
    it("should not be eligible with random same keys and different values", () => {
      const key = (Math.random() + 1).toString(36).substring(7);
      const value = Math.floor(Math.random() * 100);
      const cart = {};
      const criteria = {};
